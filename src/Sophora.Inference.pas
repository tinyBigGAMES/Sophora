...
type
  ...
  public
    ...
    function  LoadModel(const AMainGPU: Integer=-1; const AGPULayers: Integer=-1; const AFilename: string=CsoDefaultLLMFilename): Boolean; virtual;
  ...
  public
    ...
    function  LoadModel(const AMainGPU: Integer=-1; const AGPULayers: Integer=-1; const AFilename: string=CsoDefaultLLMFilename): Boolean; override;
    ...
    function  Embeddings(const APrompt: string): TArray<Single>;
...
function  TsoInference.Embeddings(const APrompt: string): TArray<Single>;
var
