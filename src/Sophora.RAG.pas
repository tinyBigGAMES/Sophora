...
type
  ...
  *)
  ...
  public
    ...
    function Open(const AInference: TsoInference; const AFilename: string; const AMainGPU: Integer=0; const AGPULayers: Integer=0): Boolean;
    procedure Close();
...
function TsoVectorDatabase.Open(const AInference: TsoInference; const AFilename: string; const AMainGPU: Integer; const AGPULayers: Integer): Boolean;
begin
  Result := False;
...
begin
  ...
  LEmbedding := FInference.Embeddings(AText);
...
begin
  ...
  LQueryEmbedding := FInference.Embeddings(AQuery);
