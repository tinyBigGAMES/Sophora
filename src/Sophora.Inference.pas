...
type
  ...
  public
    ...
    function  LoadModel(const AMainGPU: Integer=-1; const AGPULayers: Integer=-1; const AFilename: string=CsoDefaultModelFilename): Boolean; virtual;
  ...
  public
    ...
    function  LoadModel(const AMainGPU: Integer=-1; const AGPULayers: Integer=-1; const AFilename: string=CsoDefaultModelFilename): Boolean; override;
